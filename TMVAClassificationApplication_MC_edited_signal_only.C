...
void TMVAClassificationApplication_MC_edited_signal_only( TString myMethodList = "" ) {   
  ...
  TFile* output_file        = new TFile("output_file_testing_signal_all_stats.root", "RECREATE");
  ...
  output_signal_tree->Branch("spline_fix_mcweight", &output_spline_fix_mcweight, "spline_fix_mcweight/F");
  output_signal_tree->Branch("special_kdar_weight", &output_special_kdar_weight, "special_kdar_weight/F");
  ...
  output_signal_tree->Branch("rootino_fix_mcweight", &output_rootino_fix_mcweight, "rootino_fix_mcweight/F");
  output_signal_tree->Branch("central_value_mcweight", &output_central_value_mcweight, "central_value_mcweight/F");
  
  TFile *input         = TFile::Open("./input_file_rayleigh_length_testing_sample.root");
  ...
  theSignalTree->SetBranchAddress("spline_fix_mcweight", &spline_fix_mcweight);
  theSignalTree->SetBranchAddress("special_kdar_weight", &special_kdar_weight);
  ...
  theSignalTree->SetBranchAddress("rootino_fix_mcweight", &rootino_fix_mcweight);
  theSignalTree->SetBranchAddress("central_value_mcweight", &central_value_mcweight);
